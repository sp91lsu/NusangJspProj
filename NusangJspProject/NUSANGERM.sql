...
DROP TRIGGER TRI_P_LOCATION_LOCATIONNO;
DROP TRIGGER TRI_REPLY_REPLYNO;
DROP TRIGGER TRI_SELLPOST_POSTNO;
DROP TRIGGER TRI_U_LOCATION_LOCATIONNO;
...
DROP TABLE P_LOCATION CASCADE CONSTRAINTS;
...
DROP TABLE NUSANGUSER.U_LOCATION CASCADE CONSTRAINTS;
...
DROP SEQUENCE SEQ_P_LOCATION_LOCATIONNO;
DROP SEQUENCE SEQ_P_LOCATION_P_LOCATIONNO;
DROP SEQUENCE SEQ_REPLY_REPLYNO;
DROP SEQUENCE SEQ_SELLPOST_POSTNO;
DROP SEQUENCE SEQ_U_LOCATION_LOCATIONNO;
DROP SEQUENCE SEQ_U_LOCATION_U_LOCNO;
...
CREATE SEQUENCE SEQ_P_LOCATION_LOCATIONNO INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE SEQ_P_LOCATION_P_LOCATIONNO INCREMENT BY 1 START WITH 1;
...
CREATE SEQUENCE SEQ_U_LOCATION_LOCATIONNO INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE SEQ_U_LOCATION_U_LOCNO INCREMENT BY 1 START WITH 1;
...
(
	...
	IMPORT_UUID varchar2(30) NOT NULL,
...
(
	...
	BODYTEXT varchar2(4000 char) NOT NULL,
	PRICE long NOT NULL,
...
CREATE TABLE NUSANGUSER.U_LOCATION
(
	...
	NAME3 varchar2(100),
	LOCATIONNO number NOT NULL,
	CONSTRAINT SYS_C0011679 PRIMARY KEY (LOCATIONNO)
);
...
ALTER TABLE NUSANGUSER.SELLPOST
	...
	REFERENCES P_LOCATION (LOCATIONNO)
;
...
ALTER TABLE NUSANGUSER.NUSER
	ADD FOREIGN KEY (LOCATIONNO)
	REFERENCES NUSANGUSER.U_LOCATION (LOCATIONNO)
;
...
CREATE OR REPLACE TRIGGER TRI_P_LOCATION_LOCATIONNO BEFORE INSERT ON P_LOCATION
FOR EACH ROW
BEGIN
	SELECT SEQ_P_LOCATION_LOCATIONNO.nextval
	INTO :new.LOCATIONNO
	FROM dual;
END;
...
CREATE OR REPLACE TRIGGER TRI_U_LOCATION_LOCATIONNO BEFORE INSERT ON U_LOCATION
FOR EACH ROW
BEGIN
	SELECT SEQ_U_LOCATION_LOCATIONNO.nextval
	INTO :new.LOCATIONNO
	FROM dual;
END;
