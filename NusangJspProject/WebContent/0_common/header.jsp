...
<nav class="navbar navbar-expand-lg navbar-light" style = "background: #FFF; ; border-bottom: 3px solid #333">
	<a class="navbar-brand col-4" style="box-sizing: border-box; margin: 0;" href="/main"><img src="../img/ngmk_logo.png" style="width:100px; height:100px;" /></a> 
			...
			<div class="navbar-nav pull-right" style="margin-left: 35% ">
				<c:choose>
					<c:when test="${user != null}">
						...
						<li class="nav-item"><a class="nav-link" href="/myinfo/profile" style = "color:#22741C">${user.nickname} <span style = "color:black">님</span></a></li>
